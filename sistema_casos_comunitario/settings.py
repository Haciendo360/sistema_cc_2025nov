...
TEMPLATES = [
    {
        ...
        'APP_DIRS': False,  # Deshabilitado para usar loaders personalizados
        'OPTIONS': {
            'context_processors': [
            ...
            # Deshabilitar caché de templates temporalmente para forzar recarga
            'loaders': [
...
# Configuración simplificada de WhiteNoise para Render
# Usando configuración legacy que es más compatible
